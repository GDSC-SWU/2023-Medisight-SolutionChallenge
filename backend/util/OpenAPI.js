                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        await prisma.grain.create({
                            data: {
                                ...
                                classNo: data[i].CLASS_NO,
                                className: data[i].CLASS_NAME,
                                etcOtcName: data[i].ETC_OTC_NAME,
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        await prisma.permission.create({
                            data: {
                                ...
                                entpName: data[i].ENTP_NAME,
                                itemPermitDate: data[i].ITEM_PERMIT_DATE,
                                cnsgnManuf: data[i].CNSGN_MANUF,
                                etcOtcCode: data[i].ETC_OTC_CODE,
                                chart: data[i].CHART,
                                barCode: data[i].BAR_CODE,
                                materialName: data[i].MATERIAL_NAME,
                                eeDocId: data[i].EE_DOC_ID,
                                udDocId: data[i].UD_DOC_ID,
                                nbDocId: data[i].NB_DOC_ID,
                                insertFile: data[i].INSERT_FILE,
